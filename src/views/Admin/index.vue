            ...
            <el-aside width="200px">
                <el-menu default-active="1">
                    <el-menu-item index="1">
                        ...
                        <router-link to="/admin/users" tag="span" slot="title">用户管理</router-link> <!--slot代表有插槽定义在el-menu-item中 -->
                    </el-menu-item>
...
export default {
    name : 'admin',
    beforeRouteEnter (to, from, next) { //局部拦截    这个是防止通过通过输入url  直接进入admin页面
